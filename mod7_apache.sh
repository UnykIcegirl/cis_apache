...
function Mod7_1(){
   ...
   sal_71=$(getJsonEv "$nombre" "$descripcion" "$remediacion" "$resultado" "$evidencia")
   #echo -e "\n \n $sal_71"
}
...
function Mod7_2(){
   ...
   sal_72=$(getJsonEv4 "$nombre" "$descripcion" "$remediacion" "$resultado" "$evidencia" "$evid2" "$evid3" "$evid4")
   #echo -e "\n \n $sal_72"
}
...
function Mod7_3(){
   ...
   sal_73=$(getJsonEv "$nombre" "$descripcion" "$remediacion" "$resultado" "$evidencia")
   #echo -e "\n \n $sal_73"
}
...
function Mod7_4(){
   ...
   sal_74=$(getJsonEv "$nombre" "$descripcion" "$remediacion" "$resultado" "$evidencia")
   #echo -e "\n \n $sal_74"
}
...
function Mod7_5(){
   ...
   sal_75=$(getJsonEv2 "$nombre" "$descripcion" "$remediacion" "$resultado" "$evidencia" "$evid2")
   #echo -e "\n \n $sal_75"
}
