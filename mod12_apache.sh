...
function Mod12_1(){
   ...
   sal_121=$(getJsonEv "$nombre" "$descripcion" "$remediacion" "$resultado" "$(getBase64 "$evidencia")" "$id" )
   #echo -e "\n \n $sal_121"
}
...
function Mod12_3(){
  ...
  # JSON --------------------------------------------------------------------------------
   ...
   sal_123=$(getJsonEv "$nombre" "$descripcion" "$remediacion" "$resultado" "$(getBase64 "$evidencia")" "$id")
   #echo -e "\n \n $sal_123"
}
