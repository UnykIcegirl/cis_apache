...
function Mod5_1(){
   ...
   sal_51=$(getJsonEv "$nombre" "$descripcion" "$remediacion" "$resultado" "$(getBase64 "Existen $output 'Directory' y existen $param2 'Options None'")"  "$id")
   #echo -e "\n \n $sal_51"
...
function Mod5_2(){
   ...
   sal_52=$(getJsonEv "$nombre" "$descripcion" "$remediacion" "$resultado" "$(getBase64 "Existen $output 'Directory', existen $param2 'Options None' y  existen $param3 'Options Multiviews'")"  "$id")
   #echo -e "\n \n $sal_52"
...
function Mod5_3(){
   ...
   sal_53=$(getJsonEv "$nombre" "$descripcion" "$remediacion" "$resultado" "$(getBase64 "$evidencia")" "$id")
   #echo -e "\n \n $sal_53"
...
function Mod5_4(){
   ...
   sal_54=$(getJsonEv4 "$nombre" "$descripcion" "$remediacion" "$resultado" "$(getBase64 "$evidencia")"  "$(getBase64 "$evid2")"  "$(getBase64 "$evid3")"  "$(getBase64 "$evid4")" "$id")
   #echo -e "\n \n $sal_54"
}
...
function Mod5_5(){
   ...
   sal_55=$(getJsonEv2 "$nombre" "$descripcion" "$remediacion" "$resultado" "$(getBase64 "$evidencia")"  "$(getBase64 "$evid2")" "$id")
   #echo -e "\n \n $sal_55"
...
function Mod5_6(){
   ...
   sal_56=$(getJsonEv2 "$nombre" "$descripcion" "$remediacion" "$resultado" "$(getBase64 "$evidencia")"  "$(getBase64 "$evid2")" "$id" )
   #echo -e "\n \n $sal_56"
...
function Mod5_7(){
   ...
   sal_57=$(getJsonEv "$nombre" "$descripcion" "$remediacion" "$resultado" "$(getBase64 "$evidencia")" "$id")
   #echo -e "\n \n $sal_57"
...
function Mod5_8(){
   ...
   sal_58=$(getJsonEv "$nombre" "$descripcion" "$remediacion" "$resultado" "$(getBase64 "$evidencia")"  "$id" )
   #echo -e "\n \n $sal_58"
...
function Mod5_9(){
   ...
   sal_59=$(getJsonEv4 "$nombre" "$descripcion" "$remediacion" "$resultado" "$(getBase64 "$evidencia")"  "$(getBase64 "$evid2")"  "$(getBase64 "$evid3")"  "$(getBase64 "$evid4")"  "$id" )
   #echo -e "\n \n $sal_59"
...
function Mod5_10(){
   ...
   sal_510=$(getJsonEv3 "$nombre" "$descripcion" "$remediacion" "$resultado" "$(getBase64 "$evidencia")"  "$(getBase64 "$evid2")"  "$(getBase64 "$evid3")"  "$id")
   #echo -e "\n \n $sal_510"
...
function Mod5_11(){
   ...
   sal_511=$(getJsonEv4 "$nombre" "$descripcion" "$remediacion" "$resultado"  "$(getBase64 "$evidencia")"  "$(getBase64 "$evid2")"  "$(getBase64 "$evid3")"  "$(getBase64 "$evid4")"  "$id")
   #echo -e "\n \n $sal_511"
...
function Mod5_12(){
   ...
   sal_512=$(getJsonEv4 "$nombre" "$descripcion" "$remediacion" "$resultado"  "$(getBase64 "$evidencia")"  "$(getBase64 "$evid2")"  "$(getBase64 "$evid3")"  "$(getBase64 "$evid4")"  "$id")
   #echo -e "\n \n $sal_512"
...
function Mod5_13(){
   ...
   sal_513=$(getJsonEv "$nombre" "$descripcion" "$remediacion" "$resultado"  "$(getBase64 "Configuración actual $(cat "$dirConf" | grep -i \^Listen )")"  "$id")
   #echo -e "\n \n $sal_513"
...
function Mod5_14(){
   ...
   sal_514=$(getJsonEv "$nombre" "$descripcion" "$remediacion" "$resultado"  "$(getBase64 "Configuración existente de cabecero de X-Frame-Option: $(grep -i X-Frame-Options $dirConf) y configuración de cabecero Content-Security-Policy:  $(grep -i Content-Security-Policy $dirConf)")"  "$id")
   #echo -e "\n \n $sal_514"
