...
function Mod2_2(){
   ...
   sal_22=$(getJsonEv "$nombre" "$descripcion" "$remediacion" "$resultado" "$evidencia")
   #echo -e "$sal_22"
}
...
function Mod2_3(){
   ...
   sal_23=$(getJsonEv "$nombre" "$descripcion" "$remediacion" "$resultado" "$evidencia")
   #echo -e "\n \n $sal_23"
}
...
function Mod2_4(){
   ...
   sal_24=$(getJsonEv "$nombre" "$descripcion" "$remediacion" "$resultado" "$evidencia")
   #echo -e "\n \n $sal_24"
}
...
function Mod2_5(){
   ...
   sal_25=$(getJsonEv "$nombre" "$descripcion" "$remediacion" "$resultado" "$evidencia")
   #echo -e "\n \n $sal_25"
}
...
function Mod2_6(){
   ...
   sal_26=$(getJsonEv "$nombre" "$descripcion" "$remediacion" "$resultado" "$evidencia")
   #echo -e "\n \n $sal_26"
}
...
function Mod2_7(){
   ...
   sal_27=$(getJsonEv "$nombre" "$descripcion" "$remediacion" "$resultado" "$evidencia")
   #echo -e "\n \n $sal_27"
}
...
function Mod2_8(){
   ...
   sal_28=$(getJsonEv "$nombre" "$descripcion" "$remediacion" "$resultado" "$evidencia")
   #echo -e "\n \n $sal_28"
}
...
function Mod2_9(){
   ...
   sal_29=$(getJsonEv2 "$nombre" "$descripcion" "$remediacion" "$resultado" "$evidencia" "$evid2")
   #echo -e "\n \n $sal_29"
}
