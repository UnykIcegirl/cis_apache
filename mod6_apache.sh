...
function Mod6_1(){
   ...
   sal_61=$(getJsonEv3 "$nombre" "$descripcion" "$remediacion" "$resultado" "$(getBase64 "Nivel de log: $evidencia")"  "$(getBase64 "$evid2")"  "$(getBase64 "$evid3")" "$id")
   #echo -e "$sal_61"
}
...
function Mod6_2(){
   ...
   sal_62=$(getJsonEv "$nombre" "$descripcion" "$remediacion" "$resultado" "$(getBase64 "$evidencia")" "$id")
   #echo -e "$sal_62"
...
function Mod6_3(){
   ...
   sal_63=$(getJsonEv "$nombre" "$descripcion" "$remediacion" "$resultado" "$(getBase64 "$evid2")" "$id" )
   #echo -e "$sal_63"
...
function Mod6_4(){
   ...
   sal_64=$(getJsonEv3 "$nombre" "$descripcion" "$remediacion" "$resultado" "$(getBase64 "$evidencia")"  "$(getBase64 "$evid2")"  "$(getBase64 "Configuración de la rotación de log: $rotate")"  "$id")
   #echo -e "$sal_64"
...
function Mod6_6(){
   ...
   sal_66=$(getJsonEv "$nombre" "$descripcion" "$remediacion" "$resultado"  "$(getBase64 "$evidencia")" "$id")
   #echo -e "$sal_66"
...
function Mod6_7(){
   ...
   sal_67=$(getJsonEv4 "$nombre" "$descripcion" "$remediacion" "$resultado"  "$(getBase64 "$evidencia")"  "$(getBase64 "$evid2")"  "$(getBase64 "$evid3")"  "$(getBase64 "$evid4")"  "$id")
   #echo -e "$sal_67"
